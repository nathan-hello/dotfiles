...
vim.api.nvim_create_autocmd("LspAttach", {
        callback = function(event)
                ...
                map("<leader>ws", require("telescope.builtin").lsp_dynamic_workspace_symbols, "[W]orkspace [S]ymbols") -- Fuzzy find all the symbols in your current workspace Similar to document symbols, except searches over your whole project.
