config.bind("e", "config-cycle colors.webpage.darkmode.enabled true false")
...
# list) will work.
# Type: List of String
c.qt.args = ['ppapi-widevine-path=/path/to/libwidevinecdm.so']
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/nate/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/nate/.local/share/qutebrowser/userscripts/*')
